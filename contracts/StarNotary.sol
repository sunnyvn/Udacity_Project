...
contract StarNotary is ERC721 {
    ...
    string public starName = "Udacity Star";
    // symbol: Is a short string like 'USD' -> 'American Dollar'
    string public starSymbol = "US";
...
constructor() ERC721(starName, starSymbol) public { }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(tokenOwner1 == msg.sender || tokenOwner2 == msg.sender);

        //4. Use _transferFrom function to exchange the tokens.
       _transfer(tokenOwner1, tokenOwner2, _tokenId1);
       _transfer(tokenOwner2, tokenOwner1, _tokenId2);
